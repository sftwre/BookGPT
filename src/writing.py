...
class WriterChain(BaseEventChain):
    ...
    You are provided with the title, the novel's plot, a description of the main character and a plot of the current chapter.
    ...
    def run(self, genre, author, title, profile,
            plot, previous_events, summary, previous_paragraphs, current_event):
